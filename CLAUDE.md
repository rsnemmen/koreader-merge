...
Single-file Python utility (`merge_koreader.py`) that merges KOReader annotation files (`.lua`) from multiple devices into one. No external dependencies — standard library only. Python 3.6+ compatible.
...
- No external dependencies — keep the script standalone
